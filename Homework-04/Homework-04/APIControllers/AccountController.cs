...
using Homework_04.Providers;
using Homework_04.Results;
using System.Linq;
...
namespace Homework_04.Controllers
{
    ...
    public class AccountController : BaseApiController
    {
        ...
        //in next assignment, this needs to be changed to StudyCoordinator
        ...
        public async Task<IHttpActionResult> AddStudyCoordinator(RegisterBindingModel model)
        {
            ...
            //Add to role
            UserManager.AddToRole(user.Id, "StudyCoordinator");
